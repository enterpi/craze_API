...
// Get the type of environment we are running under 
...
//if (!($Environment) && ($Environment != 'PROD') && ($Environment != 'STAGE')) {
   $Environment = 'STAGE';
   $ServerName = 'ec2-54-241-213-242.us-west-1.compute.amazonaws.com';
//}

$config['Environment'] = $Environment;

// set base url on basis of DEV or PROD environment
...
// on the staging server (e.g. do-not-reply@kazaana.com) 
	...
	/* Only applicable when live server and sendmail is being used */
...
// Memcached on/off	
	$config['useMemcached'] = false; // Default ture.
	
// Restrict access to all users
	$config['restrictedAccess'] = false;
	$config['rusername'] = 'oncraze';
	$config['rpassword'] = '12345678';

// Authentication of requests (can be false for development purposes)
	$config['authenticateRequests'] = false;
	
// Encryption of responses 
	$config['encryptResponse'] = false;
	
// push notification queue to use in memcache
	$config['pushQueue1'] = 'PushQueue1';
	$config['pushQueue2'] = 'PushQueue2';
	$config['pushQueue'] = 'PushQueue';
